...
**Intuition**: posterior precision = prior precision + data precision. More data → less prior influence.
...
**Intuition**: don't use a single "best" $\theta$ — average over **all** $\theta$ weighted by their posterior probability.
