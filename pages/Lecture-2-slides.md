...
themeConfig:
  primary: '#5d8392'
title: "Lecture 2: Metric, Loss, and Optimization"
...
**Intuition**: surprising events carry more information.
...
**Intuition**: KL divergence measures the "extra bits" wasted when encoding $P$ with a code optimized for $Q$.
